...
class SimpleOrderBookTest {
    ...
    public void testAddOrders() {
        ...
        book.addOrder(new LimitOrder(17.2, 58, Side.BUY));
        ...
        book.addOrder(new LimitOrder(17.62, 350, Side.BUY));
        ...
        book.addOrder(new LimitOrder(13.72, 600, Side.SELL));
        ...
        book.addOrder(new LimitOrder(20.55, 1400, Side.BUY));
    ...
    public void testRemoveOrders() {
        ...
        Order order = new LimitOrder(16.5, 58, Side.SELL);
        book.addOrder(order);
        ...
        order = new LimitOrder(15.32, 58, Side.BUY);
        book.addOrder(order);
        ...
        order = new LimitOrder(15.32, 58, Side.SELL);
    ...
    public void testUpdateOrders() {
        ...
        Order oldOrder = new LimitOrder(16.5, 58, Side.SELL);
        book.addOrder(oldOrder);
        assertEquals(16.5, book.getBestOffer());
        assertEquals(58, book.getBestOfferVolume());

        Order newOrder = new LimitOrder(16.6, 258, Side.BUY);
        ...
        oldOrder = new LimitOrder(15.5, 58, Side.SELL);
        book.addOrder(oldOrder);
        newOrder = new LimitOrder(16.6, 258, Side.BUY);
    ...
    private OrderBook createTestOrderBook() {
        ...
        book.addOrder(new LimitOrder(12.44, 100, Side.BUY));
        book.addOrder(new LimitOrder(16.2, 108, Side.BUY));
        book.addOrder(new LimitOrder(17.23, 113, Side.SELL));
        book.addOrder(new LimitOrder(17.01, 176, Side.SELL));
        book.addOrder(new LimitOrder(16.2, 118, Side.BUY));
        book.addOrder(new LimitOrder(17.23, 198, Side.SELL));
        book.addOrder(new LimitOrder(15.32, 333, Side.BUY));
        book.addOrder(new LimitOrder(17.23, 1203, Side.SELL));
